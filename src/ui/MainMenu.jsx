...
const MainMenu = ({ onStart }) => {
  ...
  return (
    <div className="ui-overlay" style={{ background: 'var(--dark-bg)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '100dvh', overflowY: 'auto', padding: '2rem 0' }}>
